...
@NgModule({
  ...
  entryComponents: [ErrorDilogComponent],
  declarations: [AppComponent, SearchInfoComponent,
    HomeComponent, SearchDownloadComponent, IndexDownloadComponent, PageNotFoundComponent, ErrorDilogComponent, SpinnerComponent,],
  providers: [{ provide: MAT_FORM_FIELD_DEFAULT_OPTIONS, useValue: { appearance: 'fill' } }, ESConnectionService, ESUtilService, SharedVariableService,],
